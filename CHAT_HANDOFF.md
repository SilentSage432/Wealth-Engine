...
- WE-ATTENTION-005B recurrence structure discovery. Not implemented. The question is what evidence is sufficient to recognize a repeated observation structure as an environmental pattern without assigning financial semantics
