...
| Notification preference and push subscriptions | `supabase/migrations/20260929_notification_foundation.sql`, `lib/babylon/notification-records.ts`, `app/api/notifications/*`. Operational records only. They do not decide Attention or write the vault. | Persistence / Infrastructure |
