...
- [ ] Recurrence structure discovery (WE-ATTENTION-005B). Not implemented. The question is what evidence is sufficient to recognize a repeated observation structure as an environmental pattern without assigning financial semantics. It is not a search for bills or subscriptions
